import { C as getEnvString, D as state, E as isCI, _ as safeJsonStringify, a as logger, b as getEnvBool, f as extractFirstJsonObject, p as extractJsonObjects } from "./logger-DhVTSriR.js";
import { t as invariant } from "./invariant-Ddh24eXh.js";
import { r as importModule } from "./esm-B7rhRyUR.js";
import { r as runPython } from "./pythonUtils-B_6HUbaY.js";
import { i as isJavascriptFile } from "./fileExtensions-DnqA1y9x.js";
import { n as transform } from "./transform-22ugZQuZ.js";
import { B as isValidReusablePolicyId, G as MULTI_TURN_STRATEGIES, R as PolicyObjectSchema, St as PromptSchema, ut as LLAMA_GUARD_REPLICATE_PROVIDER } from "./types-Da2bFfns.js";
import { _ as extractVariablesFromTemplate, a as getNunjucksEngineForFilePath, c as maybeLoadFromExternalFile, d as maybeLoadToolsFromExternalFile, f as parsePathOrGlob, s as maybeLoadConfigFromExternalFile, x as parseFileUrl, y as getNunjucksEngine } from "./util-DBkDasQw.js";
import { d as sleep, h as REQUEST_TIMEOUT_MS, r as fetchWithTimeout, t as fetchWithProxy } from "./fetch-B8RXKmmr.js";
import { a as isCacheEnabled, i as getCache, r as fetchWithCache } from "./cache-CTFAMBrM.js";
import { $ as DefaultSynthesizeProvider$1, G as DefaultEmbeddingProvider$2, H as OpenAiModerationProvider, K as DefaultGradingProvider$3, N as REDTEAM_MEMORY_POISONING_PLUGIN_ID, O as redteamProviderManager, Q as DefaultSuggestionsProvider$2, S as removePrefix, U as MistralChatCompletionProvider, W as MistralEmbeddingProvider, X as DefaultGradingProvider$2, Y as DefaultGradingJsonProvider$2, Z as DefaultLlmRubricProvider, _ as extractVariablesFromJson, b as isBasicRefusal, et as AzureModerationProvider, f as checkExfilTracking, g as extractPromptFromTags, h as extractInputVarsFromPrompt, it as parseScriptParts, m as extractGoalFromPrompt, n as loadApiProvider, nt as AzureChatCompletionProvider, p as extractAllPromptsFromTags, rt as getFileHashes, tt as AzureEmbeddingProvider, x as isEmptyResponse, y as getShortPluginId, z as getPoliciesFromCloud } from "./providers-C5rT768O.js";
import { a as PROMPT_DELIMITER, n as maybeFilePath, r as normalizeInput } from "./utils-zX2A1CC2.js";
...
import { b as hasGoogleDefaultCredentials } from "./transform-wN5Yv5Wh.js";
import { t as AnthropicMessagesProvider } from "./messages-DeP9Qzx7.js";
import { t as OpenAiResponsesProvider } from "./responses-DiPh0CmL.js";
import { n as OpenAiEmbeddingProvider } from "./completion-BcyIYyQJ.js";
import { i as getUserEmail } from "./accounts-B3C0JTGp.js";
import { i as getRemoteGenerationUrl, l as shouldGenerateRemote } from "./server-B4bJX8L5.js";
...
function processJsonlFile(filePath, prompt) {
	const jsonLines = fs$1.readFileSync(filePath, "utf-8").split(/\r?\n/).filter((line) => line.length > 0);
...
function processTxtFile(filePath, { label }) {
	const lines = fs$1.readFileSync(filePath, "utf-8").split(/\r?\n/);
	const prompts = [];
	let buffer = [];
	const flush = () => {
...
async function loadRubricPrompt(rubricPrompt, defaultPrompt) {
	...
	if (typeof rubricPrompt === "string" && rubricPrompt.startsWith("file://")) {
		...
		if (isJavascriptFile(filePath)) rubricPrompt = await loadFromJavaScriptFile(resolvedPath, functionName, []);
			...
			if (!fs$1.existsSync(resolvedPath)) throw new Error(`File does not exist: ${resolvedPath}`);
			rubricPrompt = fs$1.readFileSync(resolvedPath, "utf8");
		}
...
//# sourceMappingURL=graders-D2bDIwZf.js.map