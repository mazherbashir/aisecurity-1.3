import { a as logger, b as getEnvBool } from "./logger-DhVTSriR.js";
import { o as cloudConfig } from "./fetch-B8RXKmmr.js";
import { o as isLoggedIntoCloud } from "./accounts-B3C0JTGp.js";
import { n as recordBlobReference, r as storeBlob } from "./blobs-eGOIe08Q.js";
...
async function uploadBlobRemote(buffer, mimeType, context) {
	...
	try {
		const { fetchWithProxy } = await import("./fetch-B8RXKmmr.js").then((n) => n.i);
...
//# sourceMappingURL=extractor-KQ00tPvr.js.map