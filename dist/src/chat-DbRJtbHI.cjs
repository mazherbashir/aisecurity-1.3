...
const HYPERBOLIC_REASONING_MODELS = [
...
function calculateHyperbolicCost(modelName, config, promptTokens, completionTokens, reasoningTokens) {
	...
	const model = HYPERBOLIC_CHAT_MODELS.find((m) => m.id === modelName || m.aliases && m.aliases.includes(modelName));
...
//# sourceMappingURL=chat-DbRJtbHI.cjs.map