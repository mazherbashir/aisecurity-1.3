import { C as getEnvString, E as isCI, a as logger } from "./logger-DWcVXa9k.js";
import { A as TERMINAL_MAX_WIDTH, a as CloudConfig, c as writeGlobalConfig, l as writeGlobalConfigPartial, r as fetchWithTimeout, s as readGlobalConfig } from "./fetch-JwctAM20.js";
...
async function checkEmailStatus(options) {
	const { default: telemetry } = await import("./telemetry-3vdJw-FZ.js").then((n) => n.r);
	const ciMode = isCI();
...
//# sourceMappingURL=accounts-9udhi6TB.js.map