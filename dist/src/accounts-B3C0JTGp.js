import { C as getEnvString, E as isCI, a as logger } from "./logger-DhVTSriR.js";
import { A as TERMINAL_MAX_WIDTH, a as CloudConfig, c as writeGlobalConfig, l as writeGlobalConfigPartial, r as fetchWithTimeout, s as readGlobalConfig } from "./fetch-B8RXKmmr.js";
...
async function checkEmailStatus(options) {
	const { default: telemetry } = await import("./telemetry-Bo6PhLgD.js").then((n) => n.n);
	const ciMode = isCI();
...
//# sourceMappingURL=accounts-B3C0JTGp.js.map